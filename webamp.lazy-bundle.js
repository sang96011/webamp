...
class Winamp {
  ...
  onTrackDidChange(cb) {
    return this._actionEmitter.on(__WEBPACK_IMPORTED_MODULE_12__actionTypes__["Q" /* SET_MEDIA */], action => {
...
/* harmony default export */ __webpack_exports__["a"] = (media => store => {
  ...
  media.on("fileLoaded", () => {
    const id = Object(__WEBPACK_IMPORTED_MODULE_2__selectors__["a" /* getCurrentTrackId */])(store.getState());
...
const mapDispatchToProps = {
  minimize: () => ({
    type: __WEBPACK_IMPORTED_MODULE_3__actionTypes__["s" /* MINIMIZE_WINAMP */]
  })
};
